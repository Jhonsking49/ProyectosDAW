...
export const saludar = (nombre) => {
    console.log(`Bienvenido ${nombre}`);      //`` -> Nombre  "template state"
};
...
// Para exportar estos elementos, deben ser explicitados con la palabra export
